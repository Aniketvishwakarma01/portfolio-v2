						...
						<div className="col-lg-5 d-flex flex-column ps-lg-8">
							<div className="d-flex align-items-center mb-3 position-relative d-inline-flex">
								...
								<div className="ps-3 h-100">
									...
									<h6 className="mb-0">+91-9369662871</h6>
								</div>
							...
							<div className="d-flex align-items-center mb-3 position-relative d-inline-flex">
								...
								<div className="ps-3 h-100">
									...
									<h6 className="mb-0">sharmaaniket396@gmail.com</h6>
								</div>
							...
							<div className="d-flex align-items-center mb-3 position-relative d-inline-flex">
								...
								<div className="ps-3 h-100">
									...
									<h6 className="mb-0">New Delhi, India</h6>
								</div>
								<a href="https://maps.app.goo.gl/ti637FTnV4h8JW2o9" className="position-absolute top-0 start-0 w-100 h-100" />
							</div>
						</div>
					</div>
				</div>
