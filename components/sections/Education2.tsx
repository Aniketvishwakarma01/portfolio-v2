										...
										<ul className="ps-3">
											<li className="position-relative z-1 mb-3">
												<div className="d-flex gap-2">
													...
													<div>
														<span className="text-primary-2">Prabhat Engineering College</span>
														<p className="text-dark">B.Tech. in Computer Science</p>
													</div>
												</div>
											</li>
											<li className="position-relative z-1 mb-3">
												<div className="d-flex gap-2">
													...
													<div>
														<span className="text-primary-2">CSJM University</span>
														<p className="text-dark">B.Sc.</p>
													</div>
												</div>
											</li>
											<li className="position-relative z-1 mb-3">
												<div className="d-flex gap-2">
													<p className="text-300 text-nowrap fw-regular mb-0">2017-2018</p>
													<div>
														<span className="text-primary-2">UP Board</span>
														<p className="text-dark">Higher Secondary Education</p>
													</div>
												</div>
											</li>
											<li className="position-relative z-1 mb-3">
												<div className="d-flex gap-2">
													<p className="text-300 text-nowrap fw-regular mb-0">2016-2017</p>
													<div>
														<span className="text-primary-2">UP Board</span>
														<p className="text-dark">Secondary Education</p>
													</div>
												</div>
											</li>
										</ul>
									...
									<ul className="ps-3">
										<li className="position-relative z-1 mb-3">
											<div className="d-flex gap-2">
												...
												<div>
													<span className="text-primary-2">Full Stack Java Development (Spring Boot & React)</span>
													<p className="text-dark">Researched scalable web apps with Spring Boot, React, REST APIs, and secure authentication.</p>
												</div>
											</div>
										</li>
										<li className="position-relative z-1 mb-3">
											<div className="d-flex gap-2">
												...
												<div>
													<span className="text-primary-2">Microservices Architecture & API Gateway</span>
													<p className="text-dark">Researched breaking monolithic apps into microservices using Spring Cloud and related tools.</p>
												</div>
											</div>
										</li>
										<li className="position-relative z-1 mb-3">
											<div className="d-flex gap-2">
												...
												<div>
													<span className="text-primary-2">Modern Frontend with React & Bootstrap</span>
													<p className="text-dark">Researched frontend best practices with reusable React components, hooks, Bootstrap, and Context API.</p>
												</div>
											</div>
										</li>
									</ul>
